...
#' @param firstInd an integer marking which occurrence of the event type should be set as the first. Default 1 sets the first occurrence.
#' @param lastEvent a string defining the last event of interest in the recording
#' @param lastInd an integer marking which occurrence of the event type should be set as the first. Default 1 sets the first occurrence.
